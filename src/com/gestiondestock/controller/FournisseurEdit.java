 ...
 */
@WebServlet(name = "FournisseurEdit", urlPatterns = "/editfournisseur")
public class FournisseurEdit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/editfournisseur.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Fournisseur tmp = fournisseurForm.nouveauFournisseur(request);
		Fournisseur fournisseur = fournisseurService.findById(tmp.getId());
		
		fournisseurService.update(fournisseur, tmp);
