			...
			<div class="row">
				<div class="col-md-3" style="padding-left: 0;">
					<nav id="sideNav"
						...
						<h1
							style="background: #117a8b; color: white; font-size: 1.5em; border-radius: 30px; padding: 1em 0;">Gestion
							de Stock</h1>
						<hr style="margin: 1em 0 6em 0;">

						<p
							style="background: #575e5f; font-size: 1em; border-radius: 30px; padding: 1em 0;">
							<a style="color: white;" href="/gestiondestock/articles">Articles</a>
						</p>
						<p
							style="background: #575e5f; font-size: 1em; border-radius: 30px; padding: 1em 0;">
							<a style="color: white;" href="/gestiondestock/fournisseurs">Fournisseur</a>
						</p>
